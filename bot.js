...
client.user.setGame(`=bc |TPG 24/7`,"http://twitch.tv/mohamedaminegamer ")
...
client.on('message', msg => {
  if (msg.content === '%support') {
    msg.reply('https://discord.gg/nfW938z');
  }
});
...
client.on('message', message => {
 ...
 __~~Bot Staff~~__
??
 __Powered By__: mohamedamine#1068
Server Support : https://discord.gg/nfW938z
`);
